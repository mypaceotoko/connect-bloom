# EnBloom Development Plan

## 現在の方向性

EnBloom は、紹介制・招待制の **コネクト SNS** として開発します。
...
EnBloom は活動・興味・共創・紹介を主目的とします。以下の方針を明確にします。
