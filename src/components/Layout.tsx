...
export function Layout() {
  ...
  return (
    <div className="min-h-screen text-theme-text">
      ...
      {showDemoBadge ? (
        <div className="pointer-events-none fixed right-3 top-[calc(env(safe-area-inset-top)+4.5rem)] z-40 rounded-full border border-theme-sky/30 bg-theme-card/90 px-2.5 py-1 text-[11px] font-semibold text-theme-main-dark shadow-[var(--shadow-card)] backdrop-blur">
          デモ閲覧
        </div>
      ) : null}
