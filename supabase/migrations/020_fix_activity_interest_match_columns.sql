-- Fix ConnectBloom activity-interest DM RPC column references.
-- activity_posts stores the post owner in created_by (not user_id), while
-- activity_post_interests stores the participant/request sender in user_id.
-- Keep the public RPC name and argument names stable for the frontend.
